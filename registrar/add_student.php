...
if (isset($_POST["submit"])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $insert = "INSERT INTO `student`(`lrn`, `fname`, `mname`, `lname`, `name`, `sex`, `birth_date`, `age`, `ra`, `house_no`, `barangay`, `municipality`, `province`, `father`, `mother`, `guardian`, `relationship`, `lm`, `contact`, `section`, `semester`,`school_year`,`track`,`strand`, `grade`, `indicator`, `ri`, `rid`)
         VALUES 
         ('$lrn','$fname','$mname','$lname','$name','$sex','$formattedBirthDate','$age','$ra','$house_no','$barangay','$municipality','$province','$father','$mother','$guardian','$relationship','$lm','$contact', '$section', '$semester', '$school_year',  '$track',  '$strand',  '$grade', '$indicator', '$ri', '$rid')";
