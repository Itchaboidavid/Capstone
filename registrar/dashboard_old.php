            ...
            <main class="py-4 px-3">
                ...
                <div class="container mt-5">
                    <div class="row text-center">
                        <h2 class="mb-5">Student Chart</h2>
                        <canvas id="studentChart" class="col-6 pb-3" style="max-width: 50%; border-bottom: 1px solid black; "></canvas>
                        <canvas id="genderChart" class="col-6 pb-3" style="max-width: 50%; border-bottom: 1px solid black;  border-left: 1px solid black;"></canvas>
                        <?php
                        //STUDENT CHART
                        ...
                        //GENDER CHART
                        $male = "SELECT * FROM `student` WHERE `sex` = 'M'";
                        $resultMale = mysqli_query($conn, $male);
                        $rowMale = mysqli_num_rows($resultMale);

                        $female = "SELECT * FROM `student` WHERE `sex` = 'F'";
                        $resultFemale = mysqli_query($conn, $female);
                        $rowFemale = mysqli_num_rows($resultFemale);
                        ?>
                        <script>
                            //STUDENT CHART
                            ...
                            const sectionChart = new Chart("studentChart", {
                                type: "bar",
                                data: {
                                    labels: xValues,
                                    datasets: [{
                            ...
                            var yValues = [<?php echo $rowMale ?>, <?php echo $rowFemale ?>];
                            var barColors = ["#003049", "#ba181b"];
