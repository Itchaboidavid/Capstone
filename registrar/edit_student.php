        ...
        <div class="row flex-nowrap g-0">
            ...
            <main class="py-4 px-3" style="background-color: #d8e2dc;">
                ...
                <form action="" method="POST" class="needs-validation w-100 row g-1" validate>
                    ...
                    <div class="form-floating mb-3 col-3 d-inline-block">
                        <input type="text" name="fname" id="fname" placeholder="fname" class="form-control bg-body-tertiary" required value="<?php echo $row["fname"] ?>" />
                        <label for="fname">First name</label>
                        <div class="valid-feedback ps-1">Great!</div>
                        <div class="invalid-feedback ps-1"> Please enter student first name.</div>
                    </div>
                    <div class="form-floating mb-3 col-3 d-inline-block">
                        <input type="text" name="mname" id="mname" placeholder="mname" class="form-control bg-body-tertiary" required value="<?php echo $row["mname"] ?>" />
                        <label for="mname">Middle name</label>
                        <div class="valid-feedback ps-1">Great!</div>
                        <div class="invalid-feedback ps-1"> Please enter student middle name.</div>
                    </div>
                    <div class="form-floating mb-3 col-3 d-inline-block">
                        <input type="text" name="lname" id="lname" placeholder="lname" class="form-control bg-body-tertiary" required value="<?php echo $row["lname"] ?>" />
                    ...
                    <div class="form-floating mb-3 d-inline-block col-2">
                        <input type="date" name="birth_date" id="birth_date" placeholder="birth_date" class="form-control bg-body-tertiary" required value="<?php echo $row["birth_date"] ?>" onchange="calculateAge()" />
                    ...
                    <div class="input-group mb-3 col" style="height: 58px;">
                        ...
                        <div class="form-floating mb-3 col-4 d-inline-block">
                            <input type="text" name="contact" id="contact" placeholder="contact" class="form-control bg-body-tertiary" required value="<?php echo $row["contact"] ?>" maxlength="10" />
...
if (isset($_POST['submit'])) {
    ...
    $update = "UPDATE `student` SET `lrn`='$lrn',`name`='$name',`fname`='$fname',`mname`='$mname',`lname`='$lname',`sex`='$sex',`birth_date`=' $formattedBirthDate',`age`='$age',`ra`='$ra',`house_no`='$house_no',`barangay`='$barangay',`municipality`='$municipality',`province`='$province',`father`='$father',`mother`='$mother',`guardian`='$guardian',`relationship`='$relationship',`contact`='$contact',`section`='$section',`semester`='$semester',`school_year`='$school_year',`track`='$track',`strand`='$strand',`grade`='$grade',`lm`='$lm',`indicator`='$indicator',`ri`='$ri',`rid`='$rid' WHERE `id` = '$id'";
