                        ...
                        <div class="card-body row g-1">
                            ...
                            <div class="form-floating mb-3 col-3 d-inline-block">
                                <select class="form-select bg-body-tertiary" name="section" id="section">
                                    <option value="<?php echo $studentRow["section"] ?>" selected><?php echo $studentRow["section"] ?></option>
                                    <?php
                                    $select = "SELECT * FROM section";
                                    $result = mysqli_query($conn, $select);
                                    while ($studentRow = mysqli_fetch_assoc($result)) {
                                    ?>
                                        <option value="<?php echo $studentRow["name"] ?>"><?php echo $studentRow["name"] ?></option>
                                    <?php }
                                    ?>
                                </select>
