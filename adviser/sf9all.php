...
$select = "SELECT * FROM student WHERE section = '$section' AND is_archived = 0";
...
foreach ($results as $result) {
    ...
    *{
    ...
    <table style="margin-left:480px; margin-top: -235px; border: no-border; ">
        ...
        <td colspan="3" style=" text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $result['name'] . '</td>
        </tr>

        <tr style="font-size: 12px;">
        <td >Age:</td>
        <td  style="width:132px;text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $result['age'] . '</td>
        <td style="width:58px;">Sex:</td>
        <td  style="text-align: center; font-weight:bold; border-bottom:1px solid black; width:220px;">' . $result['sex'] . '</td>
        </tr>

        <tr style="font-size: 12px;"> 
        <td >Grade:</td>
        <td  style="text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $result['grade'] . '</td>
        <td >Section:</td>
        <td  style="text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $result['section'] . '</td>
        </tr>

        <tr style="font-size: 12px;">
        <td >School Year:</td>
        <td  style="text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $result['school_year'] . '</td>
        <td >LRN:</td>
        <td  style="text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $result['lrn'] . '</td>
        </tr>

        <tr style="font-size: 12px;">
        <td >Track/Strand:</td>
        <td colspan="3"  style="text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $result['track'] . " - " . $result['strand'] . '</td>
        </tr>
