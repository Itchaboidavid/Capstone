...
$section = "SELECT * FROM section WHERE adviser_id = '$adviser_id' AND school_year_id = '$school_year_id' AND is_archived = 0";
$sectionResult = $conn->query($section);
$sectionRow = $sectionResult->fetch_assoc();
$sectionName = $sectionRow['name'];

$students = "SELECT * FROM student WHERE section = '$sectionName' AND school_year_id = '$school_year_id' AND is_archived = 0 ORDER BY `name`";
...
<table style="margin-left:480px; margin-top: -235px; border: no-border; ">
      ...
      <td colspan="3" style=" text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $studentRow['name'] . '</td>
      </tr>

      <tr style="font-size: 12px;">
      <td >Age:</td>
      <td  style="width:132px;text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $studentRow['age'] . '</td>
      <td style="width:58px;">Sex:</td>
      <td  style="text-align: center; font-weight:bold; border-bottom:1px solid black; width:220px;">' . $studentRow['sex'] . '</td>
      </tr>

      <tr style="font-size: 12px;"> 
      <td >Grade:</td>
      <td  style="text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $studentRow['grade'] . '</td>
      <td >Section:</td>
      <td  style="text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $studentRow['section'] . '</td>
      </tr>

      <tr style="font-size: 12px;">
      <td >School Year:</td>
      <td  style="text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $studentRow['school_year'] . '</td>
      <td >LRN:</td>
      <td  style="text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $studentRow['lrn'] . '</td>
      </tr>

      <tr style="font-size: 12px;">
      <td >Track/Strand:</td>
      <td colspan="3"  style="text-align: center; font-weight:bold; border-bottom:1px solid black;">' . $studentRow['track'] . " - " . $studentRow['strand'] . '</td>
      </tr>
