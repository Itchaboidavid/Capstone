...
$section = "SELECT * FROM `section` WHERE `name` = '$sectionName' AND is_archived = 1";
...
$select = "SELECT *  FROM student WHERE sex = 'M' AND section = '$sectionName' AND is_archived = 1 ORDER BY name ASC";
...
$select = "SELECT *  FROM student WHERE sex = 'F' AND section = '$sectionName' AND is_archived = 1 ORDER BY name ASC";
$result = mysqli_query($conn, $select);
$femaleCount = 1;
$totalAbsentFemale = 0;
