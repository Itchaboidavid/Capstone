...
$id = $_SESSION['id'];
$adviser = "SELECT * FROM `user` WHERE id = '$id'";
...
/*Header */
$student = "SELECT * FROM student WHERE section = '$section_name' AND is_archived = 0 AND school_year_id = '$school_year_id' ORDER BY `name`";
